...
const mainContentWrap=document.querySelector(".main-content"),menuBtn=document.querySelector(".menu-btn"),sideMenu=document.querySelector(".side-menu"),callorderButtons=document.querySelectorAll("[data-modal]"),closeButtons=document.querySelectorAll(".modal-close"),flatVisualContainers=document.querySelectorAll(".flat-visual"),flatVisualChangeButons=document.querySelectorAll(".changeFlatVisual");function addClass(e,t){e.classList.contains(t)||e.classList.add(t)}function removeClass(e,t){e.classList.contains(t)&&e.classList.remove(t)}function toggleClass(e,t){e.classList.contains(t)?e.classList.remove(t):e.classList.add(t)}function toggleTabs(e,t){if(!e||!t)return;const s=t.querySelectorAll(".tab");e.classList.contains("active")||e.classList.add("active"),s&&s.length>0&&s.forEach(t=>{t===e&&t.classList.contains("active")||t!==e&&t.classList.contains("active")&&t.classList.remove("active")})}function changeContentSlide(e,t){if(!e||!t)return;const s=t.querySelectorAll(".content-slide");s&&s.length>0&&s.forEach(t=>{t===e&&"block"===t.style.display||(t!==e&&"block"===t.style.display?t.style.display="none":t.style.display="block")})}function changeFlatsVisual(e,t){flatVisualContainers&&t&&flatVisualContainers.forEach(e=>{e===t?removeClass(e,"d-none"):addClass(e,"d-none")}),flatVisualChangeButons&&e&&flatVisualChangeButons.forEach(t=>{t===e?addClass(t,"active"):removeClass(t,"active")})}Fancybox.defaults.closeButton=!1,Fancybox.bind("[data-fancybox]",{}),closeButtons&&closeButtons.forEach(e=>{e.addEventListener("click",()=>{Fancybox.getInstance().close()})}),menuBtn&&menuBtn.addEventListener("click",()=>{toggleClass(menuBtn,"active"),toggleClass(sideMenu,"active"),toggleClass(mainContentWrap,"darken")}),$(".js-range-slider").ionRangeSlider({});
