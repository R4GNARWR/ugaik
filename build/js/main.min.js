const planPathes=document.querySelectorAll(".facade-plan__path"),floorPathes=document.querySelectorAll(".floor_path"),closeButtons=document.querySelectorAll(".modal-close");Fancybox.defaults.closeButton=!1,closeButtons.forEach(o=>{o.addEventListener("click",()=>{Fancybox.close()})}),planPathes.forEach(o=>{o.addEventListener("click",()=>{Fancybox.show([{src:"#floorModal",type:"inline"}],{dragToClose:!1,mainClass:"modal-floor__container"})})}),Fancybox.bind("[data-fancybox]",{}),floorPathes.forEach(o=>{o.addEventListener("click",()=>{Fancybox.show([{src:"#flatModal",type:"inline"}],{dragToClose:!1,mainClass:"modal-floor__container"})})});
