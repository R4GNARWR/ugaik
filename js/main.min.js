const planPathes=document.querySelectorAll(".facade-plan__path"),floorPathes=document.querySelectorAll(".floor_path");Fancybox.defaults.closeButton=!1,planPathes.forEach(o=>{o.addEventListener("click",()=>{Fancybox.show([{src:"#floorModal",type:"inline"}],{dragToClose:!1,mainClass:"modal-floor__container"})})}),floorPathes.forEach(o=>{o.addEventListener("click",()=>{Fancybox.show([{src:"#flatModal",type:"inline"}],{dragToClose:!1,mainClass:"modal-floor__container"})})});
